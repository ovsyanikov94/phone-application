...
export default class PhonePage{
    ...
    onPhoneSelected( event ){
        ...
        let parent = event.target.closest('[data-element="phone"]');

        if(!parent){
            return;
        }//if

        console.log(parent.dataset.phoneId);
    ...
    async _load(){
        ...
        try{
            ...
            this._catalogue._element.addEventListener( 'click' , this.onPhoneSelected.bind(this) );
